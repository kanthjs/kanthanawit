...
description: อัปเดตครบจบในบทความเดียว! ตั้งแต่ Setup โครงสร้าง ไปจนถึง CI/CD ด้วย GitHub Actions พร้อมเครื่องมือยุคใหม่อย่าง Positron, pak และ Quarto ที่ช่วยให้การพัฒนา R Package เร็วและสนุกยิ่งขึ้น
date: '2026-03-12'
...
::: {.callout-note}
## 💡 Tip: ใช้ `use_import_from` เพื่อความเร็ว
