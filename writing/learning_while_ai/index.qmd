...
description: ทำไมใช้ AI เขียนโค้ดแล้วรู้สึกว่าตัวเองไม่เก่งขึ้น? ทำความรู้จัก Learning Opportunities Skill ที่จะเปลี่ยน AI ให้เป็นโค้ชส่วนตัวเพื่อให้เราเรียนรู้ได้จริง
date: '2026-03-06'
categories:
  - R
  - Claude
